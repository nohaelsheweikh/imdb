...
// global.tripsData = null
 class WarningList extends RkComponent {
    state = {
      data:null,
      themeColor:'',
      hasScrolled: false,
    ...
    componentWillReceiveProps(nextProps) {
        if(!_.isEqual(nextProps.Warningtrips,this.props.Warningtrips)){ 
         
            this.setState({
                data: [...this.state.data,...nextProps.Warningtrips]
            })
        }
    }

   componentDidMount() {
     this.setState({data:this.props.Warningtrips})
   }
...
render = () => (
  // console.log('warning',this.state.data),
         <FlatList
            ...
            onEndReached={this.props.WarningmoreFunction.bind(this)}
    ...
    export default withNavigation(WarningList);